...
def create_model():
    ...
    # feature selection
    s = layers.Dense(149)(norm_inp)  # score
    ...
    conv = layers.Conv1D(filters=32, kernel_size=3)(expanded_inp)
    conv = layers.BatchNormalization()(conv)
    conv = layers.Activation("relu")(conv)
    
    att = MyAtt(depth=16, num_heads=8)(conv, conv, conv)
    att = layers.BatchNormalization()(att)
    
    fc = SEBlock(reduction_ratio=2)(att)
