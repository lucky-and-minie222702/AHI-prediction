...
def create_model():
    ...
    en = ResNetBlock(1, en, 64, 7, True)
    en = ResNetBlock(1, en, 64, 7)
    en = ResNetBlock(1, en, 64, 5, True)
    en = ResNetBlock(1, en, 64, 5)
    ...
    de = ResNetBlock(1, expanded_en, 64, 3, True, True, activation=layers.LeakyReLU(negative_slope=0.25))
    de = ResNetBlock(1, de, 64, 3, False, True, activation=layers.LeakyReLU(negative_slope=0.25))
    de = ResNetBlock(1, de, 64, 5, True, True, activation=layers.LeakyReLU(negative_slope=0.25))
    de = ResNetBlock(1, de, 64, 5, False, True, activation=layers.LeakyReLU(negative_slope=0.25))
    de = ResNetBlock(1, de, 64, 7, True, True, activation=layers.LeakyReLU(negative_slope=0.25))
    de = ResNetBlock(1, de, 64, 7, False, True, activation=layers.LeakyReLU(negative_slope=0.25))
    ...
    de_rpa = ResNetBlock(1, de_rpa, 64, 5, True)
    de_rpa = ResNetBlock(1, de_rpa, 64, 5)
    de_rpa = ResNetBlock(1, de_rpa, 64, 7, True)
    de_rpa = ResNetBlock(1, de_rpa, 64, 7)
    ...
    de_rri = ResNetBlock(1, de_rri, 64, 5)
    de_rri = ResNetBlock(1, de_rri, 64, 7, True)
    de_rri = ResNetBlock(1, de_rri, 64, 7)
